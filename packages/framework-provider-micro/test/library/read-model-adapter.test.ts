...
describe('read-models-adapter', () => {
    ...
    describe('fetchReadModel', () => {
        ...
        it('should call read model registry query and return a value', async () => {
            ...
            const result: ReadModelInterface = await fetchReadModel(mockConfig, mockLogger, mockReadModelTypeName, mockReadModelID)
        ...
        it('should call read model registry query and no results', async () => {
            queryStub.resolves([])
            const result = await fetchReadModel(mockConfig, mockLogger, mockReadModelTypeName, mockReadModelID)
    ...
    describe('storeReadModel', () => {
        ...
        beforeEach(async () => {
            ...
            await storeReadModel(mockConfig, mockLogger, mockReadModel.typeName, mockReadModel.value, 1)
        })

        it('should call read model registry store', () => {
            expect(storeStub).to.have.been.calledWithExactly(
                { typeName: mockReadModel.typeName, 'value.id': mockReadModel.value.id },
                mockReadModel,
            )
        })
    ...
    describe('searchReadModel', () => {
        it('empty query should call read model registry store', async () => {
            ...
            await searchReadModel(mockConfig, mockLogger, mockReadModel.typeName, {})
